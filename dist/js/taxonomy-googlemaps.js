...
/***/ "./resources/js/googlemaps-geolocation.js":
/*!************************************************!*\
  !*** ./resources/js/googlemaps-geolocation.js ***!
  \************************************************/
/*! no static exports found */
...
module.exports = function (map, bounds, infoWindow) {
  var createHTMLMapMarker = __webpack_require__(/*! @posterno/google-maps-html-marker */ "./node_modules/@posterno/google-maps-html-marker/index.js"); // Prepare markup of the button.
  ...
  buttonUI.innerHTML = '<i class="fas fa-location-arrow"></i>'; // Add button to the map.

  map.controls[google.maps.ControlPosition.LEFT_TOP].push(buttonUI); // Make the button do something.
...
/***/ "./resources/js/taxonomy-googlemaps.js":
/*!*********************************************!*\
  !*** ./resources/js/taxonomy-googlemaps.js ***!
  \*********************************************/
/*! no static exports found */
...
(function (window, document, $, undefined) {
  ...
  var GeolocationButton = __webpack_require__(/*! ./googlemaps-geolocation */ "./resources/js/googlemaps-geolocation.js"); // The clustering library.


  var GoogleClusters = __webpack_require__(/*! @google/markerclustererplus */ "./node_modules/@google/markerclustererplus/src/markerclusterer.js"); // Parameters for the api request.
    ...
    loadGoogleMapsApi(apiConfig).then(function (googleMaps) {
      $(PosternoTaxonomyMap.map_elements).each(function () {
        ...
        if (singleMap.length) {
          ...
          var bounds = new google.maps.LatLngBounds(); // Determine the position of the infowindow.
          ...
          var AvailableMarkers = PosternoTaxonomyMap.getMarkers();
          var MarkersList = []; // Loop listings and create a marker.
          ...
          var markerCluster = new GoogleClusters(map, MarkersList); // Center the map so that all markers can be seen.
          ...
          var geoButton = GeolocationButton(map, bounds, infoWindow); // Enable bootstrap tooltips on the button.
...
/***/ 1:
/*!***************************************************!*\
  !*** multi ./resources/js/taxonomy-googlemaps.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /Users/alessandrotesoro/Local Sites/posterno/app/public/wp-content/plugins/posterno-maps/resources/js/taxonomy-googlemaps.js */"./resources/js/taxonomy-googlemaps.js");


/***/ })

/******/ });
//# sourceMappingURL=taxonomy-googlemaps.js.map